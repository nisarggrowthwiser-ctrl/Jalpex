...
const translations = {
  en: {
    ...
    inquiry_desc: "Contact us for bulk orders, custom packaging requirements, and competitive export pricing.",
    form_quote_title: "Request a Quote",
  ...
  hi: {
    ...
    inquiry_title: "अपना ऑर्डर देने के लिए तैयार हैं?",
    inquiry_desc: "थोक ऑर्डर, कस्टम पैकेजिंग आवश्यकताओं और प्रतिस्पर्धी निर्यात मूल्य निर्धारण के लिए हमसे संपर्क करें।",
    form_quote_title: "एक बोली का अनुरोध करें",
  ...
  ar: {
    ...
    inquiry_title: "هل أنت مستعد لتقديم طلبك؟",
    inquiry_desc: "اتصل بنا لطلبات الجملة، متطلبات التعبئة والتغليف المخصصة، وأسعار التصدير التنافسية.",
    form_quote_title: "طلب اقتباس السعر",
  ...
  fr: {
    ...
    inquiry_title: "Prêt à passer votre commande ?",
    inquiry_desc: "Contactez-nous pour les commandes en gros, les exigences d'emballage personnalisées et les prix d'exportation compétitifs.",
    form_quote_title: "Demander un Devis",
  ...
  es: {
    ...
    inquiry_title: "¿Listo para realizar su pedido?",
    inquiry_desc: "Contáctenos para pedidos al por mayor, requisitos de embalaje personalizados y precios de exportación competitivos.",
    form_quote_title: "Solicitar una Cotización",
  ...
  de: {
    ...
    inquiry_title: "Bereit für Ihre Bestellung?",
    inquiry_desc: "Kontaktieren Sie uns für Großbestellungen, maßgeschneiderte Verpackungsanforderungen und wettbewerbsfähige Exportpreise.",
    form_quote_title: "Angebot Anfordern",
  ...
  pt: {
    ...
    inquiry_label: "Contacto",
    inquiry_title: "Pronto para fazer seu pedido?",
    inquiry_desc: "Entre em contato conosco para pedidos em lote, requisitos de embalagem personalizados e preços de exportação competitivos.",
    form_quote_title: "Solicitar Orçamento",
  ...
  zh: {
    ...
    inquiry_label: "联系我们",
    inquiry_title: "准备好下单了吗？",
    inquiry_desc: "联系我们以获取大宗订单、定制包装要求和极具竞争力的出口定价。",
    form_quote_title: "请求报价",
